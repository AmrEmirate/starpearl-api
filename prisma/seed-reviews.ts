...
async function main() {
  ...
  const positiveReviews = [
    ...
    },
    {
      rating: 4,
      content:
        "Bagus sih, cuma packagingnya bisa lebih rapi. Tapi overall puas!",
    },
    {
      rating: 5,
      content:
        "Udah beli berkali-kali di sini, gak pernah mengecewakan ⭐⭐⭐⭐⭐",
    },
    {
      rating: 4,
    ...
    },
    {
      rating: 4,
      content:
        "Bagus kok, cuma warnanya sedikit beda sama di foto. But still good!",
    },
    {
      rating: 5,
