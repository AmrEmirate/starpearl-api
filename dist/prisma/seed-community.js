...
async function main() {
    ...
    const posts = [
        {
            content: "Baru beli kalung mutiara ini! Cantik banget 😍✨ Cocok buat ke kantor atau acara formal",
            img: "https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=500",
        },
        {
            content: "Koleksi gelang terbaru aku 💫 Semuanya dari Starpearl, kualitasnya bagus banget!",
            img: "https://images.unsplash.com/photo-1611652022419-a9419f74343d?w=500",
        },
        {
            content: "Tips: Simpan perhiasan di tempat kering ya guys, biar gak cepat kusam 💎",
            img: null,
        },
        {
            content: "Anting-anting lucu buat daily look! Simpel tapi tetap elegan ✨",
        ...
        {
            content: "Jam tangan classic never goes wrong! Bisa dipake formal atau casual 🕐",
            img: "https://images.unsplash.com/photo-1524592094714-0f0654e20314?w=500",
        },
        {
            content: "Beach day vibes dengan anklet bohemian 🏖️ Siapa yang suka gaya ini?",
        ...
        {
            content: "Ikat pinggang kulit bisa upgrade tampilan casual jadi lebih polished!",
            img: "https://images.unsplash.com/photo-1624222247344-550fb60583dc?w=500",
        },
        {
            content: "Syal pashmina wajib punya buat yang sering di ruangan ber-AC 🧣",
        ...
        {
            content: "Tassel earrings untuk look yang lebih dramatis di acara special ✨",
            img: "https://images.unsplash.com/photo-1630019852942-f89202989a59?w=500",
        },
        {
            content: "Statement ring yang jadi conversation starter setiap ketemu orang 💍",
            img: "https://images.unsplash.com/photo-1603561591411-07134e71a2a9?w=500",
        },
        {
            content: "Hairpin mutiara cantik buat acara wisuda nanti! Yang lagi nyari inspirasi? 🎓",
        ...
        {
            content: "Review jujur: Kacamata baca retro ini nyaman banget dipake lama! 📖",
            img: "https://images.unsplash.com/photo-1574258495973-f010dfbb5371?w=500",
        },
        {
            content: "Travel pouch essential! Makeup jadi rapi gak berantakan di tas 💄",
        ...
        {
            content: "Payung auto open-close compact, muat di tas kecil! Essential banget ☂️",
        ...
        {
            content: "Bangle set gold finish ini aku layering 4 sekaligus! Makin kece 🌟",
        ...
        {
            content: "Phone strap beads DIY style! Siapa yang juga lagi suka bikin gini? 📱",
